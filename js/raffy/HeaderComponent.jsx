...
const { cm, helpers } = component(__CURRENT_MODULE_PATH); 

export default class HeaderComponent extends cm.ComponentElement {  
    constructor() { 
        super();       
        this.state = {};
    }  
    render() {  
        return (
            <div data-component-type={__CURRENT_MODULE_PATH}>
